...
public class FishermanInputReportController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        quantityColumn.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getQuantity()));
        ...
        priceColumn.setCellValueFactory(param -> new SimpleIntegerProperty(param.getValue().getPrice()));
        ...
        TextFields.bindAutoCompletion(fishermanTextField, t -> FishermenNames.stream().filter(user -> {
            ...
            return user.getName().matches(regex) || String.valueOf(user.getDarshKey()).matches(regex);
